...
export const products: LoanProduct[] = [
  ...
  },
  {
    ...
    description:
      "A small-value credit product designed for short, well-defined needs. This product is not operational yet and is planned for a later phase.",
    phase2: true,
    range: { min: 1_000, max: 50_000 },
    tenure: { model: "months", min: 1, max: 12, default: 3 },
    indicativeRate: { min: 0, max: 0 },
    whyShriNeo: [
      "Designed for clarity on small amounts, where fees matter most.",
      "Same consent, disclosure and grievance standards as our other products.",
      "Will launch only once participating lenders and controls are in place.",
    ],
    eligibility: [
      "Eligibility criteria will be published when this product launches.",
      "Existing ShriNeo customers will be informed before availability.",
    ],
    documents: [
      {
        label: "To be published at launch",
        why: "Document requirements depend on the participating lenders for this product.",
      },
    ],
    faqs: [
      {
        q: "Can I apply for a Sachet Loan today?",
        a: "No. This product is planned for Phase 2 and no application, decision or disbursal workflow is live.",
      },
      {
        q: "Will I be notified when it launches?",
        a: "Yes. Registered users will be informed once the product is available.",
      },
    ],
  },
];
