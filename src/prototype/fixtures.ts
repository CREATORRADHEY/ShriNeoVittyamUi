...
export interface RequestEntity {
  ...
  status: "New" | "Opened" | "Draft" | "Submitted" | "Received" | "Under review" | "Accepted" | "Rejected";
...
export const CANONICAL_DOCUMENTS: DocumentEntity[] = [
  ...
  { id: "D-3", appId: "APP-2026-001284", name: "6 Months Bank Statements", type: "M", status: "Rejected", reason: "PDF password incorrect" }
];

export const CANONICAL_OFFERS: OfferEntity[] = [
  { id: "OFF-1", appId: "APP-2026-001284", lenderName: "SBI Digital Finance", amount: 350000, tenure: 36, apr: 11.5, emi: 11540, fee: 3500 },
  { id: "OFF-2", appId: "APP-2026-001284", lenderName: "HDFC Bank Spark", amount: 320000, tenure: 36, apr: 12.2, emi: 10650, fee: 3000 },
  { id: "OFF-3", appId: "APP-2026-001284", lenderName: "ICICI Instant Credit", amount: 350000, tenure: 36, apr: 12.9, emi: 11780, fee: 4000 }
];
...
export const CANONICAL_GRIEVANCE: GrievanceEntity = {
  ...
  status: "Open",
  conversation: [
    { sender: "you", text: "My Aadhaar has my middle name but PAN doesn't. How do I verify?", time: "12 Mar, 10:00" },
    { sender: "agent", text: "I have uploaded the name mismatch confirmation. Admin is reviewing.", time: "12 Mar, 11:30" }
  ]
};

export const CANONICAL_AUDIT_LOGS: AuditEventEntity[] = [
  { id: "AUD-101", timestamp: "08 Mar 2026, 11:04", actor: "Rohit Sharma", action: "Consent Authorized", details: "Approved credit bureau query consent" },
  { id: "AUD-102", timestamp: "09 Mar 2026, 16:20", actor: "L-904 (SBI)", action: "PII Unmasked", details: "Unmasked name and phone number for manual verification" },
  { id: "AUD-103", timestamp: "11 Mar 2026, 09:45", actor: "L-904 (SBI)", action: "Info Requested", details: "Requested re-upload of bank statements (REQ-884021)" }
];
