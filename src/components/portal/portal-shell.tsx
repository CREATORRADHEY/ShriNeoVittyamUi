...
export const PORTAL_NAV: Record<Role, NavItem[]> = {
  borrower: [
    ...
    { label: "CIBIL Score", to: "/app/borrower/cibil-score", icon: BarChart3 },
    { label: "SNV Trust Score", to: "/app/borrower/snv-trust-score", icon: Activity },
    { label: "Find a Loan Agent", to: "/app/borrower/agents", icon: Users },
