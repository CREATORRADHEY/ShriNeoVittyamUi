          ...
          <ol className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {content.steps.map((step, i) => (
              <li
                key={step.title}
                className={cn(
                  "group min-w-0 border-t border-[#ECE7DD] pt-[22px]",
                  !shown && "opacity-0",
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <span className="flex size-10 shrink-0 items-center justify-center rounded-[10px] bg-[#E6F1FB] text-[#0051AE] transition-transform duration-[180ms] ease-[cubic-bezier(0.2,0,0,1)] group-hover:-translate-y-px motion-reduce:transition-none">
                    {STEP_ICONS[i]}
                  </span>
