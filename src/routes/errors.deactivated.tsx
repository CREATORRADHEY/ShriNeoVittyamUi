...
export const Route = createFileRoute("/errors/deactivated")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Access historical records or start a reactivation request." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Account no longer active — ShriNeo Capital" },
      { property: "og:description", content: "Access historical records or start a reactivation request." },
    ],
  }),
