...
const spec: PortalPageSpec = {
  ...
  table: {
    ...
    entity: "reviews",
    columns: ["Application", "Referral reason", "Amount", "Age", "Reviewer", "Status"],
    rows: [
      [
        "SNV-24-118198",
        "Income volatility",
  ...
  metaDescription:
    "Work the files that automated policy referred for human judgement, with the referral reason on each.",
};
