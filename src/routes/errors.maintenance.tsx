...
export const Route = createFileRoute("/errors/maintenance")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Planned platform maintenance is in progress. Records are unaffected." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Scheduled maintenance — ShriNeo Capital" },
      { property: "og:description", content: "Planned platform maintenance is in progress. Records are unaffected." },
    ],
  }),
