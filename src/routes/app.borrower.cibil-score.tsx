...
function CibilScorePage() {
  ...
  const [bureauState, setBureauState] = useState<
    "not-checked" | "checking" | "available" | "NH" | "failed"
  >("available");
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {bureauState === "checking" && (
          <div className="flex flex-col items-center justify-center rounded-xl border border-border bg-card p-12 text-center">
            ...
            <p className="mt-2 max-w-[40ch] text-xs text-muted-foreground">
              Establishing secure encrypted API hookup to TransUnion database. This check is a soft
              inquiry.
            </p>
          </div>
        )}
          ...
          <SectionCard title="Bureau Inquiry Authorization" description="Soft pull query terms">
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">
                In compliance with CICRA and RBI lending parameters, we require your explicit
                authorization to check your credit history with TransUnion CIBIL.
              </p>
              <div className="rounded-lg bg-surface border border-border p-4 text-xs text-muted-foreground space-y-2">
                <p>
                  1. This check is registered as a "Soft Inquiry" and does not impact your credit
                  score.
                </p>
                <p>
                  2. ShriNeo Capital does not share this report with third parties without your
                  active consent.
                </p>
              </div>
              <div className="flex items-start gap-2.5">
                ...
                <label
                  ...
                  className="text-xs text-foreground font-medium select-none cursor-pointer"
                >
                  I authorize ShriNeo Capital to retrieve my credit score on my behalf from
                  TransUnion CIBIL.
                </label>
              </div>
        ...
        {bureauState === "available" && (
          <div className="grid gap-6 md:grid-cols-3">
            <div className="md:col-span-1 flex flex-col items-center justify-center rounded-xl border border-border bg-card p-6 text-center">
              ...
              <span className="mt-2 text-xs font-semibold text-emerald-600 bg-emerald-50 rounded px-2.5 py-0.5 border border-emerald-200">
                GOOD
              </span>
              ...
              <Button
                ...
                onClick={() => setBureauState("not-checked")}
              >
            ...
            <div className="md:col-span-2 space-y-6">
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Excellent history of credit card and active loan service payments.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Card outstanding amounts are well below the combined credit limit.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Having accounts open longer helps lenders confirm repayment stability.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <SectionCard title="Dispute & Reporting Guidance">
                <div className="space-y-3 text-sm">
                  <p className="text-xs text-muted-foreground">
                    Notice a mistake in your report? Lenders must resolve CIBIL disputes under RBI
                    guidelines.
                  </p>
                  <Button
                    size="sm"
                    ...
                    onClick={() => toast.info("Dispute checklist downloaded.")}
                  >
              ...
              <SectionCard title="Inquiry Ledger">
                <div className="rounded border border-border bg-surface p-3 text-xs flex justify-between items-center text-muted-foreground">
                  <span>
                    Inquiry ID:{" "}
                    <span className="font-mono text-foreground font-semibold">TU-2026-993821</span>
                  </span>
        ...
        {bureauState === "NH" && (
          <SectionCard
            title="Thin File Status: No History (NH)"
            description="What this means for your application"
          >
            <div className="space-y-4">
              <div className="rounded-lg bg-surface border border-border p-4 text-sm space-y-2">
                <p className="font-semibold text-foreground">
                  Score Result: NH / No bureau matches found.
                </p>
                <p className="text-xs text-muted-foreground">
                  This happens if you have never taken a loan, credit card, or post-paid utility
                  mandate in your name. Lenders cannot assess credit history.
                </p>
              </div>
              <div className="rounded-lg border border-[#DDE7F5] bg-white p-5 space-y-3">
                <h4 className="font-semibold text-sm text-foreground">
                  How ShriNeo resolves thin files:
                </h4>
                <p className="text-xs text-muted-foreground">
                  Our <strong>advisory SNV Trust Score</strong> reads bank account deposits,
                  cashflow stability, and utility mandates, allowing you to qualify even with no
                  bureau records.
                </p>
        ...
        {bureauState === "failed" && (
          <div className="flex flex-col items-center justify-center rounded-xl border border-red-200 bg-red-50 p-12 text-center">
            ...
            <p className="mt-2 max-w-[42ch] text-xs text-red-900/80">
              The TransUnion server could not find record matches for your name and PAN number.
              Ensure your PAN details are identical to your income proof documentation.
            </p>
