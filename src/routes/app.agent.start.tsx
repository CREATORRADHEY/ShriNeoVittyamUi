...
const spec: PortalPageSpec = {
    ...
    "notices": [
      {
        ...
        "explanation": "The borrower receives an OTP and a plain-language summary of what will be checked. Nothing is submitted until they approve it on their own phone.",
    ...
    "emptyExplanation": "Drafts are kept for 14 days so you can finish a file after collecting a missing paper.",
    "footnote": "Never collect money from a borrower. Your commission is paid by ShriNeo Capital after disbursal.",
    "metaTitle": "Start an application",
    "metaDescription": "Begin an application for a borrower with consent captured up front and every step recorded."
  };
...
export const Route = createFileRoute("/app/agent/start")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Begin an application for a borrower with consent captured up front and every step recorded." },
      { name: "robots", content: "noindex, nofollow" },
      { property: "og:title", content: "Start an application — ShriNeo Capital" },
      { property: "og:description", content: "Begin an application for a borrower with consent captured up front and every step recorded." },
    ],
  }),
