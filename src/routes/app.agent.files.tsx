...
const spec: PortalPageSpec = {
    ...
    "emptyExplanation": "Start an application for a borrower and it will appear here with its live status.",
    "metaTitle": "My files",
    "metaDescription": "Every application you started, its current stage and the exact item it is waiting on."
  };
...
export const Route = createFileRoute("/app/agent/files")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Every application you started, its current stage and the exact item it is waiting on." },
      { name: "robots", content: "noindex, nofollow" },
      { property: "og:title", content: "My files — ShriNeo Capital" },
      { property: "og:description", content: "Every application you started, its current stage and the exact item it is waiting on." },
    ],
  }),
