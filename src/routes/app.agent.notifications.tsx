...
const spec: PortalPageSpec = {
  ...
  table: {
    ...
    columns: ["When", "Notification", "File", "Status"],
    rows: [
      [
        "12 Mar 2026, 11:20",
  ...
  emptyExplanation:
    "Assignments and lender queries will appear here, and we will also send you an SMS.",
  metaTitle: "Agent notifications",
  metaDescription:
    "Every alert about lead assignments, lender queries, document rejections and commission payouts.",
};
