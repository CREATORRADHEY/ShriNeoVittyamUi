...
const spec: PortalPageSpec = {
    ...
    "metaDescription": "Download approved explainers, checklists and disclosure material you can share with borrowers."
  };
...
export const Route = createFileRoute("/app/agent/resources")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Download approved explainers, checklists and disclosure material you can share with borrowers." },
      { name: "robots", content: "noindex, nofollow" },
      { property: "og:title", content: "Agent resources — ShriNeo Capital" },
      { property: "og:description", content: "Download approved explainers, checklists and disclosure material you can share with borrowers." },
    ],
  }),
