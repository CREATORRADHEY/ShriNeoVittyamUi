...
export const Route = createFileRoute("/errors/unsupported-browser")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Some features may not work in this browser version. Guidance and safe continuation." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Browser not fully supported — ShriNeo Capital" },
      { property: "og:description", content: "Some features may not work in this browser version. Guidance and safe continuation." },
    ],
  }),
