...
const spec: PortalPageSpec = {
    ...
    "emptyExplanation": "Invoices are raised on the first working day of each month for the month before.",
    "restrictedFor": [
      "agent",
      "borrower"
    ],
    "metaTitle": "Billing and ledgers",
    "metaDescription": "Sourcing fee invoices, settlement status and reconciliation exceptions for your account."
  };
...
export const Route = createFileRoute("/app/lender/billing")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sourcing fee invoices, settlement status and reconciliation exceptions for your account." },
      { name: "robots", content: "noindex, nofollow" },
      { property: "og:title", content: "Billing and ledgers — ShriNeo Capital" },
      { property: "og:description", content: "Sourcing fee invoices, settlement status and reconciliation exceptions for your account." },
    ],
  }),
