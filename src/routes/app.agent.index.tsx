...
function AgentDashboard() {
  ...
  const banner = payoutSkipped ? (
    <InlineState
      ...
      actions={[
        {
          label: "Complete Bank Details",
          variant: "default",
          onClick: () => {
            setPayoutSkipped(false);
            toast.info("Launch bank settings.");
          },
        },
      ]}
    />
      ...
      actions={[
        {
          ...
          variant: "default",
          onClick: () => toast.info("Launch bank settings."),
        },
      ]}
    />
  ) : data === "offline" ? (
    ...
    >
      {account === "suspended" || account === "restricted" ? (
        ...
        <AgentOnboardingDashboard
          ...
          setPayoutSkipped={setPayoutSkipped}
        />
      ) : (
        ...
        <>
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            <KpiCard
              label="New leads"
              value={data === "empty" ? "0" : "4"}
              hint="Assigned in last 48h"
              state={data === "empty" ? "empty" : "ready"}
            />
            <KpiCard
              label="Files in progress"
              value={data === "empty" ? "0" : "11"}
              hint="3 awaiting borrower"
              state={data === "empty" ? "empty" : "ready"}
            />
            <KpiCard
                    ...
                    {LEADS.map((l) => (
                      ...
                      >
                        ...
                        <td className="p-3">
                          <StatusBadge
                            tone={
                              claimedLeads.includes(l.name) || l.consent === "Approved"
                                ? "success"
                                : l.consent === "Pending"
                                  ? "warning"
                                  : "error"
                          ...
                          {l.consent === "Pending" && !claimedLeads.includes(l.name) ? (
                            <Button
                              ...
                              onClick={() => {
                                ...
                                toast.success(
                                  `Lead successfully claimed and locked under First-Valid-Accept protocol.`,
                                );
                              }}
                            >
                              Claim & Lock Lead
          ...
          {data === "empty" ? (
            <div className="grid gap-4 md:grid-cols-2">
              <EmptyState
                ...
                actions={[
                  { label: "Start an application with borrower consent", to: "/app/agent/start" },
                ]}
              />
              <EmptyState
                compact
            ...
            <div className="grid gap-4 lg:grid-cols-3">
              <SectionCard title="Consent Gate Guard" className="lg:col-span-1">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Every file requires an OTP approved by the borrower on their own mobile. There
                    is no agent bypass.
                  </p>
                </div>
              ...
              <SectionCard title="Earnings and payouts" className="lg:col-span-2">
                <ul className="divide-y divide-border text-sm">
                  {[
                    {
                      label: "Estimated (files in review)",
                      value: formatINR(21400),
                      note: "Not payable until disbursal is confirmed",
                    },
                    {
                      label: "Earned and verified",
                      value: formatINR(48250),
                      note: "Included in next payout run",
                    },
                    {
                      label: "TDS deducted",
                      value: `− ${formatINR(4825)}`,
                      note: "Statutory 10% deduction at source",
                    },
                    {
                      label: "Payout scheduled",
                      value: "18 Mar 2026",
                      note: "To your verified bank account",
                    },
                  ].map((row) => (
                    <li
                      key={row.label}
                ...
                <div className="mt-4 flex flex-wrap items-center gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      if (payoutSkipped) {
                        toast.error(
                          "Payout blocked: bank credentials setup was skipped during onboarding.",
                        );
                      } else {
          ...
          <SectionCard title="Compliance" description="Renewals keep your verified status active">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <StatusBadge tone="success">Training current until 12 Sep 2026</StatusBadge>
  ...
  const quizQuestions = [
    {
      ...
      options: [
        "Yes, up to 1%",
        "No, ShriNeo Capital is a zero-fee platform for borrowers",
        "Only if the file is rejected",
      ],
      correct: 1,
    },
    {
      ...
      options: [
        "Yes, to help speed up submission",
        "Only with written permission",
        "No, the borrower must authorize OTP checks on their own device",
      ],
      correct: 2,
    },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50 p-4 text-amber-900 text-xs">
        ...
        <div>
          ...
          <p className="mt-1">
            KYC review is pending admin activation. Complete the step-by-step checklist to finalize
            registration.
          </p>
        </div>
      </div>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          {step === "otp" && (
            <SectionCard
              ...
              description="RBI-mandated security check"
            >
              <div className="space-y-4 text-xs">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    <Label htmlFor="phoneOtp" className="mb-1 block font-medium">
                      Mobile OTP (Simulated "123456")
                    </Label>
                    <Input
                      id="phoneOtp"
                      maxLength={6}
                  ...
                  <div>
                    <Label htmlFor="emailOtp" className="mb-1 block font-medium">
                      Email OTP (Simulated "123456")
                    </Label>
                    <Input
                      id="emailOtp"
                      maxLength={6}
                ...
                <Button size="sm" onClick={handleVerifyOtp} className="mt-2">
          ...
          {step === "agreement" && (
            <SectionCard
              title="Step 2 · Partner Code of Conduct Agreements"
              description="Statutory compliance statements"
            >
              <div className="space-y-4 text-xs">
                <div className="space-y-3">
                  <div className="flex items-start gap-2">
                    ...
                    <Label htmlFor="agree1" className="leading-relaxed font-normal">
                      I acknowledge that ShriNeo Capital is a <strong>zero-fee platform</strong> for
                      borrowers. I will never collect processing fees or commissions directly from
                      any applicant.
                    </Label>
                  </div>
                  <div className="flex items-start gap-2">
                    ...
                    <Label htmlFor="agree2" className="leading-relaxed font-normal">
                      I will respect client data privacy. I will never look up or ask for OTPs or
                      sensitive digital signatures belonging to borrowers.
                    </Label>
                  </div>
                  <div className="flex items-start gap-2">
                    <input
                    ...
                    <Label htmlFor="agree3" className="leading-relaxed font-normal">
                      I agree to the sourcing-partner code of conduct terms and verify that all
                      documents submitted are true scans.
                    </Label>
                  </div>
                </div>
                <Button size="sm" onClick={handleAcceptAgreement}>
                  Sign Agreement
                </Button>
              </div>
            </SectionCard>
          ...
          {step === "bank" && (
            <SectionCard
              title="Step 3 · Payout Bank Account Setup"
              description="Details for receiving commissions"
            >
              <div className="space-y-4 text-xs">
                <div className="grid gap-3 sm:grid-cols-3">
                  <div>
                    <Label htmlFor="bankName" className="mb-1 block font-medium">
                      Bank Name
                    </Label>
                    <Input
                      id="bankName"
                  ...
                  <div>
                    <Label htmlFor="accountNo" className="mb-1 block font-medium">
                      Account Number
                    </Label>
                    <Input
                      id="accountNo"
                  ...
                  <div>
                    <Label htmlFor="ifscCode" className="mb-1 block font-medium">
                      IFSC Code
                    </Label>
                    <Input
                      id="ifscCode"
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  <Button size="sm" onClick={handleSaveBankDetails}>
                    Save Bank Account
                  </Button>
                  <Button size="sm" variant="outline" onClick={handleSkipBankDetails}>
                    Skip for now
                  </Button>
                </div>
              </div>
          ...
          {step === "training" && (
            <SectionCard
              title="Step 4 · Mandatory Compliance Training"
              description="Complete training to activate dashboard"
            >
              <div className="space-y-4 text-xs">
                <div className="p-3 border border-border rounded bg-surface flex justify-between items-center">
                  <div>
                    <h4 className="font-semibold text-foreground">
                      Module 3: Document Standards & OCR Auditing
                    </h4>
                    <p className="text-[10px] text-muted-foreground">
                      Status: {videoCompleted ? "Completed" : "Awaiting review"}
                    </p>
                  </div>
                  <Button
                    size="xs"
                ...
                {trainingCertificate && (
                  <div className="p-4 border border-emerald-200 bg-emerald-50 rounded-lg text-center space-y-3">
                    ...
                    <p className="text-[10px] text-emerald-900/80">
                      Your agent training certificate is now ready.
                    </p>
                    <div className="flex justify-center gap-2">
                      <Button
                        ...
                        onClick={() =>
                          toast.success(
                            "ShriNeo Agent Training Certificate downloaded successfully.",
                          )
                        }
                      >
                        Download Certificate
                      </Button>
                      <Button size="sm" variant="outline" onClick={handleCompleteOnboarding}>
          ...
          {step === "review" && (
            <SectionCard
              title="KYC & Credential Review In Progress"
              description="Manual activation pending"
            >
              <div className="space-y-4 text-xs text-center p-6">
                ...
                <p className="text-muted-foreground max-w-[45ch] mx-auto">
                  Your onboarding credentials and signed agreement have been submitted. If you
                  skipped payout bank details, you may add them in your profile settings while you
                  wait.
                </p>
                <div className="pt-4 border-t border-border flex justify-center gap-2">
                  <Button
                    ...
                    variant="outline"
                    onClick={() =>
                      toast.success("Review timeline refreshed: Expected within 24 hours.")
                    }
                  >
        ...
        <div className="space-y-6">
          <SectionCard title="Activation Checklist">
            <div className="space-y-3 text-xs">
              ...
              <div
                className={`flex items-center gap-2 ${step !== "otp" ? "text-emerald-700" : "text-muted-foreground"}`}
              >
                {step !== "otp" ? (
                  <CheckCircle2 className="size-4 shrink-0" />
                ) : (
              ...
              <div
                className={`flex items-center gap-2 ${agree1 && agree2 && agree3 ? "text-emerald-700" : "text-muted-foreground"}`}
              >
              ...
              <div
                className={`flex items-center gap-2 ${!payoutSkipped && bankName ? "text-emerald-700" : payoutSkipped ? "text-amber-700" : "text-muted-foreground"}`}
              >
                {!payoutSkipped && bankName ? (
                  <CheckCircle2 className="size-4 shrink-0" />
                ) : payoutSkipped ? (
              ...
              <div
                className={`flex items-center gap-2 ${trainingCertificate ? "text-emerald-700" : "text-muted-foreground"}`}
              >
                {trainingCertificate ? (
                  <CheckCircle2 className="size-4 shrink-0" />
                ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 backdrop-blur-sm p-4">
          <div className="w-full max-w-[500px] rounded-xl border border-border bg-card p-6 shadow-xl space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-foreground mb-4">{quizQuestions[currentQuizIndex]?.q}</p>
          ...
          <div className="w-full max-w-[500px] rounded-xl border border-border bg-card p-6 shadow-xl text-center space-y-4">
            <div className="flex justify-between items-center border-b border-border pb-2">
              <h3 className="font-bold text-sm text-foreground flex items-center gap-1.5">
                <BookOpen className="size-5 text-primary" /> Module 3: Document Standards & OCR
                Auditing
              </h3>
              <button
                type="button"
            ...
            <div className="aspect-video w-full rounded-lg bg-neutral-900 border border-border flex items-center justify-center overflow-hidden relative">
              <div className="absolute inset-0 bg-neutral-800 flex flex-col items-center justify-center text-xs text-neutral-200 p-4">
                <span className="animate-pulse font-semibold">
                  🔴 VIDEO PLAYBACK — MODULE 3 TUTORIAL
                </span>
                <p className="mt-4 max-w-[40ch] text-[10px] text-muted-foreground text-center">
                  "Ensure Bank Statements PDFs uploaded are clean, unlocked, and cover the requested
                  six-month range. Avoid partial scanner captures."
                </p>
              </div>
            </div>
            ...
            <div className="pt-2 border-t border-border flex justify-between items-center">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  toast.success("Module 3 video completed.");
                }}
              >
                Mark Completed
              </Button>
