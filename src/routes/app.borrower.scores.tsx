...
const spec: PortalPageSpec = {
  ...
  emptyExplanation:
    "Scores appear after your first consented check. We use a soft enquiry, which never affects your bureau score.",
  metaTitle: "Your scores",
  metaDescription:
    "See your bureau score and SNV Trust Score, what moves them and how lenders read them.",
};
