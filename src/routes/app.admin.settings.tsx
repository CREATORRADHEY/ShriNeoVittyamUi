...
const spec: PortalPageSpec = {
    ...
    "metaDescription": "Configure platform-wide policy, roles, retention and the controls that require two approvals."
  };
...
export const Route = createFileRoute("/app/admin/settings")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Configure platform-wide policy, roles, retention and the controls that require two approvals." },
      { name: "robots", content: "noindex, nofollow" },
      { property: "og:title", content: "Platform settings — ShriNeo Capital" },
      { property: "og:description", content: "Configure platform-wide policy, roles, retention and the controls that require two approvals." },
    ],
  }),
