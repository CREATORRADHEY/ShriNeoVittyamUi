...
const spec: PortalPageSpec = {
  ...
  table: {
    ...
    entity: "audit events",
    columns: ["When", "Actor", "Event", "Reference", "Result"],
    rows: [
      [
        "12 Mar 2026, 11:22",
        "A. Rao",
  ...
  emptyExplanation:
    "The log is never empty for long. Widen the date range to see earlier activity.",
  footnote: "Audit records cannot be edited or deleted by any user, including administrators.",
  metaTitle: "Audit log",
  metaDescription:
    "Append-only record of credit decisions, PII unmasking and permission changes with actor and reason.",
};
