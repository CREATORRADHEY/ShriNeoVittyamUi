...
const spec: PortalPageSpec = {
  ...
  table: {
    caption: "Users",
    entity: "users",
    columns: ["User", "Role", "Approval limit", "Last active", "Status"],
    rows: [
      [
        "A. Rao",
        "Credit approver",
  ...
  emptyExplanation:
    "Invite your credit team and assign approval limits before the first file arrives.",
  footnote: "Every permission change is written to the audit log with the approver's identity.",
  metaTitle: "Team and permissions",
  metaDescription:
    "Manage lender users, roles and approval limits, with every permission change recorded.",
};
