...
const spec: PortalPageSpec = {
  ...
  emptyExplanation:
    "Analytics appear once you have completed five files, so the numbers mean something.",
  metaTitle: "Agent analytics",
  metaDescription:
    "Understand your conversion rate, drop-off points and turnaround times across products.",
};
